...
let s:purple = { 'cterm': 141, 'gui': '#FFAA22' }
...
let s:dark_bg = { 'cterm': 235, 'gui': '#262626' }
...
call Highlight('Normal', { 'fg': s:white, 'bg': s:dark_bg, 'style': s:none })
...
call Highlight('CursorLineNR', { 'fg': s:orange, 'bg': s:none, 'style': s:italic })
