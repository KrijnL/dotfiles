# Generated by Powerlevel10k configuration wizard on 2021-02-16 at 13:01 CET.
...
() {
  ...
  function prompt_my_pulumi() {
    if [[ -f "Pulumi.yaml" ]]; then
      stack=$(find ~/.pulumi/workspaces/VPC-$(echo -n "$(pwd)/Pulumi.yaml" | sha1sum | cut -d ' ' -f 1)*| xargs cat | jq '.stack' -r)
      p10k segment -t "$stack" -b green -f yellow -i '' 
    fi
  }
  ...
  function instant_prompt_my_pulumi() {
    prompt_my_pulumi
  }
